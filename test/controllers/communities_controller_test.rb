...
class CommunitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create community" do
    assert_difference("Community.count") do
      post communities_url, params: { community: { c_id: @community.c_id, name: @community.name } }
    end
  ...
  test "should update community" do
    patch community_url(@community), params: { community: { c_id: @community.c_id, name: @community.name } }
